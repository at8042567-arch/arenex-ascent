  ...
  return (
    <div className="min-h-screen pt-24">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {webDevPlans.map((plan, index) => (
              <div
                key={index}
                className={`glass-card p-8 rounded-2xl relative transition-all duration-500 hover:border-primary/30 hover:-translate-y-2 animate-fade-in-up delay-${(index + 3) * 100}`}
              >
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="glass-card p-12 md:p-16 text-center max-w-4xl mx-auto animate-scale-in">
